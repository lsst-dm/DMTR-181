...
\textbf{ DAQ Validation} (LDM-503-10),
...
The current status of test plan \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testPlan/LVV-P54}{LVV-P54} in Jira is \textbf{ Completed }.
...
\multicolumn{2}{p{10.9cm}}{\textbf{ LDM-503-10: DAQ Validation }} & Completed \\\hline
\multicolumn{2}{r}{ T. Cycle \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCycle/LVV-C107}{LVV-C107}:} &
\multicolumn{2}{p{10.9cm}}{\textbf{ LDM-503-10 DAQ verification }} & Done \\\hline
...
\begin{minipage}[]{9cm}
\smallskip
The ``machines'' are the archiver and the forwarder. ~ These systems are
at the BDC which is where the comcam system was for this test. ~The DWDM
network will not be used with this configuration due to re-design of
comcam at the base and that the MTcam support systems will be at the
summit with everything else. ~ ~Testing the DWDM is no longer necessary
for DAQ effectiveness.~~
\medskip
\end{minipage}
&   \\\hline
...
Final comment:\\The ``machines'' are the archiver and the forwarder. ~ These systems are
at the BDC which is where the comcam system was for this test. ~The DWDM
network will not be used with this configuration due to re-design of
comcam at the base and that the MTcam support systems will be at the
summit with everything else. ~ ~Testing the DWDM is no longer necessary
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
Images found on archiver in correct place. ~ Image is full 9 CCD.~~
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
EFD and SAL messages all show that the archiver has the image, and
forwarder communicated with archiver that the image was built and good.
~ Header service produced good headers so a intact FITS file was
produced.~~
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
communication for images taken and ``grabbed'' from DAQ took place.
~\\[4\baselineskip]
